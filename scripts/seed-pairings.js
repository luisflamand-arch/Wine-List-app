...
function seedPairings() {
    return __awaiter(this, void 0, void 0, function () {
        var pairings, _i, pairings_1, pairing, err_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    pairings = [
                        ...
                        {
                            dishName: "Burrata",
                            premiumWineId: "chardonnay-borgona",
                        ...
                        },
                        {
                            ...
                            premiumWineId: "riesling-alsacia",
                            mediumWineId: "l-pez-haro-blanco-viura",
                            economicWineId: "vino-blanco-sauvignon"
                        },
                        {
                        ...
                        },
                        {
                            ...
                            premiumWineId: "pinot-noir-oregon",
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < pairings_1.length)) return [3 /*break*/, 4];
                    pairing = pairings_1[_i];
                    return [4 /*yield*/, prisma.menuPairing.upsert({
                ...
                case 2:
                    _a.sent();
                    console.log("\u2705 ".concat(pairing.dishName));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
                ...
                case 5:
                    err_1 = _a.sent();
                    console.error("❌ Error:", err_1 instanceof Error ? err_1.message : String(err_1));
                    return [3 /*break*/, 8];
